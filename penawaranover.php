    ...
    <div class="penawaran" id="penawaranContent">
        ...
        <div class="mt-4 d-flex gap-3">
            ...
            <!-- <a class="btn btn-primary"
                href="https://api.whatsapp.com/send?phone=6285817298071&text=<?= urlencode("Saya ingin mengajukan penawaran untuk item *$item* sebanyak *$jumlah*.") ?>"
                target="_blank">
                💬 Ajukan via WhatsApp
            </a> -->
            <?php
...
*PT. WAE MANDIRI KARYA*
Jl. BKKBN No. 7 RT. 02 RW.07, Mustika Jaya, Bekasi 17158
📧 pt.waemandirikarya@gmail.com
📞 0812 6888 8969

*Kepada:* PT. STAINLESS STEEL PRIMAVALVE MAJU BERSAMA
*Re:* $item
*Tanggal:* " . date('d M Y') . "
*Nomor PNR:* PNR006-WMK-05-2025-SPV
...
• Diskon 10%: Rp" . number_format($diskon, 0, ',', '.') . "
• Jumlah Setelah Diskon: Rp" . number_format($totalSetelahDiskon, 0, ',', '.') . "
...
?>
            ...
            <a class="btn btn-primary"
                href="https://api.whatsapp.com/send?phone=6285817298071&text=<?= urlencode($pesan) ?>" target="_blank">
                💬 Ajukan via WhatsApp
            </a>
